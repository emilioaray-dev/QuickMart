...
export const fr: Translation = {
  ...
  cash: "Espèces",
  cashDescription: "Payer au comptoir",
  ...
  addedAnotherToCart: "Ajout d'un autre",
  itemRemoved: "Article retiré du panier",
  cartCleared: "Panier vidé",
  cartIsEmpty: "Votre panier est vide",
  purchaseComplete: "Achat terminé! Merci d'avoir fait vos achats avec nous.",
  ...
  bakery: "Boulangerie",
  beverages: "Boissons",
  meatSeafood: "Viandes et Fruits de Mer",
  vegetables: "Légumes",
  snacks: "Collations",
